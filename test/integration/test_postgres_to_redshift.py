...
class TestBasicIncrementalPipeline(BaseTestPostgresToRedshift):
    ...
    def setUp(self):
        with self.source_conn.cursor() as cur:
            ...
            COMMENT ON TABLE test_basic IS 'This is a table generated by the druzhba tests';
            COMMENT ON COLUMN test_basic.value1 IS 'This is a comment with this: '' special character';
            COMMENT ON COLUMN test_basic.enum_value IS 'This is a very special enum column that can have values `a`, `b`, `c`';
            """
            )
    ...
    def test_run_incremental(self):
        ...
        with self.target_conn.cursor() as cur:
            ...
            result = cur.fetchone()
            self.assertEqual(
                result[0], "This is a table generated by the druzhba tests"
            )
        ...
        with self.target_conn.cursor() as cur:
            ...
            expected_column_comments = {
                "pk": None,
                "updated_at": None,
                "value1": "This is a comment with this: ' special character",
                "enum_value": "This is a very special enum column that can have values `a`, `b`, `c`",
            }
